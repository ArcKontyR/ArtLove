...
define config.version = "0.2.1.0"

## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p("""Визуальная новелла «Искусство и любовь» разработана командой «Однажды в УрФУ»:\n
...
В разработке был использован плагин PhoneTexting от Nighten: {a=https://nighten.itch.io/yet-another-phone-renpy/}Ссылка на проект{/a}
В игре присутствует множество музыки с авторским правом, продукт не является коммерческим.
""")
...
define config.save_directory = "Art&Love-1698065016"
