label first_act:
    ...
    gg second "Нет, иногда шляюсь по разным подработкам, чтобы заработать денег на краску, 
    ...
    scene bg nastya hallway with fade
